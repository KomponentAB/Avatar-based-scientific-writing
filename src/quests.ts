...
const quests = [
  ...
  },
  {
    questId: "quest2",
    questDescription:
      "Sprich mit Prof. Mumblecore am nördlichen Ende der großen Halle.",
    requireQuest: "quest1",
  },
  {
    questId: "quest3",
  ...
  },
  {
    questId: "quest5",
    questDescription:
      "Finde den geheimen Eingang zum Kondensatorium und gib dort den Zahlencode ein.",
    requireQuest: "quest4",
  },
  {
    questId: "quest6",
  ...
  },
  {
    questId: "quest8",
    questDescription:
      "Geh durch das erste offene Portal und gelange zu deiner ersten Aufgabe. Sprich dort mit der zitierenden Zirze ",
    requireQuest: "quest7",
  },
  {
    questId: "quest9",
  ...
  },
  {
    questId: "quest12a",
    questDescription:
      "Geh in den nächsten Raum und sprich mit der zitierenden Zirze",
  ...
  },
  {
    questId: "quest16",
    questDescription:
      "Geh durch das Portal zurück zum Knotenpunkt des Kondensatoriums und bearbeite Modul 3! ",
  ...
  },
  {
    questId: "quest23",
    questDescription:
      "Bearbeite das Lernmaterial zur Literaturverwaltung mit Zotero",
  ...
  },
  {
    questId: "quest26",
    questDescription:
      "Geh durch das Portal zurück zum Knotenpunkt des Kondensatoriums und gebe dort die gesammelten Wortschnipsel in der korrekten Reihenfolge ein!",
